<template>
  <md-card
    md-with-hover
    class="card-style card-technology"
  >
    <md-card-header>
    ...
    <md-card-content>
      <md-button
        ...
        v-on:click="clearAllClick"
      >Clear All</md-button>
      <md-button
        class="md-raised"
        v-on:click="showOverlayClick"
        ...
        <md-menu-content class="custom-menu-content">
          <div class="civ-selection-list">
            <md-menu-item
              ...
              :id="civName"
            >
              <div class="civ-icon-group">
                <div
                  class="civ-icon"
                  :style="civIconStyle(civName)"
                />
                <div
